...
"dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "deer"]
...
while True:
    ...
    for i in range(detected_objects.shape[2]):
        ...
        if confidence > min_confidence:
            ...
            print(f"{classes[class_index]}: {confidence:.2f}%") # printing class in console
            print(time.time())
